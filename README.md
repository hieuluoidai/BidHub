\# Thành viên \& Phân công - Nhóm 6



\*\*Dự án:\*\* Online Auction System (Hệ thống đấu giá trực tuyến)

\*\*Môn học:\*\* Lập trình nâng cao — K70 UET VNU
...
| \*\*4\*\* | \*\*Nguyễn Văn Khánh Duy\*\* | \*\* Database \& SQL\*\*<br>• Thiết kế schema MySQL (users, items, auctions, bid\_transactions)<br>• Viết các lớp DAO (UserDAO, AuctionDAO, ItemDAO, BidTransactionDAO)<br>• Quản lý kết nối database (DatabaseConnection Singleton)<br>• Truy vấn phức tạp (tìm người thắng, đếm bid, thống kê) |
